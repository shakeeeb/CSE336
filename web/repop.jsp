<%-- 
    Document   : repop
    Created on : Apr 11, 2015, 5:31:05 PM
    Author     : MK
--%>
...
<!DOCTYPE html>
  ...
  <!-- Masthead/footer -->
  <link href="dw-mf.css" media="screen,projection" rel="stylesheet" title="www" type="text/css">
  <link href="dw-mf-minimal-N.css" media="screen,projection" rel="stylesheet" title="www" type="text/css">
  <!-- Home CSS -->
  <link href="dwwi-v17.css" media="screen,projection" rel="stylesheet" title="www" type="text/css">
  <script src="www.js"></script>
  <script src="eluminate.js"></script><script src="head.js"></script><script src="50200000.js"></script>
  <script src="dw-www.js"></script><script charset="utf-8" src="Dialog.xd.js"></script>
  ...
  <script src="usen-utf8.js" id="dojoIoScript2" charset="utf-8"></script><script src="cookie-id.js"></script><script src="rules_50200000.js"></script><script src="dispatcher-v3.js"></script><script charset="utf-8" src="move.xd.js"></script><script charset="utf-8" src="TimedMoveable.xd.js"></script><script charset="utf-8" src="_CssStateMixin.xd.js"></script><script charset="utf-8" src="_FormMixin.xd.js"></script><script charset="utf-8" src="_DialogMixin.xd.js"></script><script charset="utf-8" src="DialogUnderlay.xd.js"></script><script charset="utf-8" src="ContentPane.xd.js"></script><script charset="utf-8" src="common.xd.js"></script><script charset="utf-8" src="TooltipDialog.xd.js"></script><script src="yahoo-min.js"></script><script src="cp-v3.js"></script><script charset="utf-8" src="Mover.xd.js"></script><script charset="utf-8" src="Moveable.xd.js"></script><script src="json-min.js" ></script><script charset="utf-8" src="_ContentPaneResizeMixin.xd.js"></script><script charset="utf-8" src="html.xd.js"></script><script charset="utf-8" src="loading.xd.js"></script><script charset="utf-8" src="common.xd(1).js"></script><script type="text/javascript" charset="utf-8" src="autoscroll.xd.js"></script><script charset="utf-8" src="_LayoutWidget.xd.js"></script>
  </head>
    ...
    <div id="ibm-masthead" role="banner">
      ...
      <div id="dw-masthead-top-row">
        <ul id="ibm-mast-options-dw" role="toolbar">
          <li role="presentation" id="dw-mast-top-4"> <a href="http://www.ibm.com/developerworks/"><img src="developerWorks_registration_files/dwn-dw-badge.png" width="43" height="22" alt="dW" aria-label="dW"></a> </li>
      ...
      <div id="ibm-universal-nav-dw" aria-label="Site map">
        <ul id="ibm-unav-links-dw">
          <li id="ibm-unav-home-dwlogo"><a href="http://www.ibm.com/developerworks/"><img src="developerWorks_registration_files/dwn-dw-wordmark.png" width="225" height="28" alt="developerWorks&#xc2;&#xae;"></a></li>
        </ul>
      </div>
    </div>
          ...
          <div id="ibm-content-main"> 
            ...
            <div class="ibm-columns"> 
              ...
              <div class="ibm-col-6-4">
                ...
                <form method="post" action="http://localhost:8080/CSE336/HWservlet" class="ibm-row-form" name="register" id="registerform">
                  ...
                  <div class="ibm-columns">
                    <div class="ibm-col-2-1">
                      <p>
                        ...
                        <span class="dw-lc-formerror" id="empty_invalid" style="display:none;">You need to input a value.</span> <span class="dw-lc-formconfirm" id="empty_valid" style="display:none;">&nbsp;</span> 
                  ...
                  <p>
                    ...
                    <span>
                        <input name="Password" id="Password" size="42" type="password" value="${bean.password}" onKeyUp="validatePassword();" onBlur="validatePassword();">
                    </span> <span class="dw-lc-formerror" id="password_invalid" style="display:none;">The password you entered is not valid and your field must be not empty!</span> <span class="dw-lc-formconfirm" id="password_valid" style="display:none;">&nbsp;</span> </p>
                  <p>
                  ...
                  <p>
                    <label for="alias">Display name:<span class="ibm-required">*</span><br>
                      <span class="ibm-additional-info dw-lc-labeloverride dw-lc-important-adjust ibm-item-note">(Must be between 3 - 31 characters. <a class="ibm-feature-link" href="www.helloworld.com" onClick="ibmweb.overlay.show(&#39;overlay2&#39;, this);return false;">Tips for choosing display name.</a>) 
                  ...
                  <div class="ibm-common-overlay" id="overlay2">
                    <div class="ibm-head">
                      <p> <a class="ibm-common-overlay-close" href="www.helloworld.com">Close [x]</a> 
                  ...
                  <div class="ibm-columns">
                    <div class="ibm-col-2-1">
                      <p>
                        ...
                        <span>
                            <input name="City" id="City" size="36" type="text" value="${bean.city}">
                        </span> </p>
                    </div>
                    <div class="ibm-col-2-1">
                      <p>
  ...
  ">
                  ...
                  <div class="ibm-buttons-row">
                    <p>
                      ...
                      <input value="http://www.ibm.com/developerworks/topics%2" type="hidden" name="d" id="d">
                      ...
                      <input value="Cancel" type="button" name="ibm-cancel" class="ibm-btn-cancel-sec" onClick="window.location(window.location.href = &#39;http://www.ibm.com/developerworks/topics%2&#39;)">
                    </p>
                  </div>
                  <div class="dw-lc-spacevertical">&nbsp;</div>
                  <div class="dw-lc-spacevertical">&nbsp;</div>
              ...
              <div class="ibm-col-6-2">
                <div class="ibm-container">
                  <h2>Why register?</h2>
                  <div class="ibm-container-body"> <img src="developerWorks_registration_files/hiviz-mydw-new.jpg" width="168" height="64" alt="Register for mydeveloperWorks">
        ...
        <div class="ibm-common-overlay" id="overlay">
          <div class="ibm-head">
            <p><a class="ibm-common-overlay-close" href="www.helloworld.com">Close [x]</a></p>
          </div>
          <!--https://www.ibm.com/developerworks/dwwi/jsp/Register.jsp?lang=en_US&appname=developerworks&d=http%3A%2F%2Fwww.ibm.com%2Fdeveloperworks%2Ftopics%2#close-->
          
          <div class="ibm-body">
            <div class="ibm-main"> <a class="ibm-access" id="overlaylink1"><!-- Accessibility anchor --></a>
              <div class="ibm-title">
  ...
  <div id="ibm-metrics"> 
    ...
    <a id="icon-id08384998918045312" style="cursor: pointer;">Advertising Choices</a></div>
  <script type="text/javascript" src="notice"></script><script defer async src="notice(1)"></script>
  </body>
  </html>
